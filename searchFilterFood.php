...
?>
            ...
            ?>
            <!-- <script>
            document.querySelector("#foundMessage").innerHTML += "<?php echo "</td><td id='res_link'> <a title='Bring me to $res_name' href=dashboard.php?page=menu&Restaurant_ID=" . $res_id . ">" . $res_name . "</a></td></tr>" ?>";
            onFoundMessage();
        </script> -->
