...
<body id="food-body">
  ...
  <main>
    ...
    $sql = "SELECT Count(Food_ID), Order_No FROM foodorder WHERE Student_ID = $student_id and Order_Date='$today' and Order_Status='Order' GROUP BY Order_No ORDER BY Order_No";
