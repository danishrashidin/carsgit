    ...
    fetch("activityHandler.php", {
      ...
      .then((cancelation) => {
        if (cancelation.status == "success") {
          ...
          currentCancelRegistrationButton.parentNode.parentNode.parentNode.querySelector(".status").innerHTML = "Available";
          currentCancelRegistrationButton.parentNode.parentNode.parentNode.querySelector(".status").style.background = "#00df89";
